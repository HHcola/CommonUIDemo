...
public class SlidingUpPanelLayout extends ViewGroup {
     ...
     */
    private static final int DEFAULT_FADE_COLOR = 0xbb000000;
     ...
     * @param paddingTop
     */
    public void setTouchdisablePaddingTop(float paddingTop) {
    	mPaddingTop = paddingTop;
    }

    public void setSlidingUp(boolean slidingUp) {
    	mIsSlidingUp = slidingUp;
    }
    /**
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        if (mPaddingTop != 0 && ev.getY() <= mPaddingTop) {
        	return false;
        }
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (mCanSlide && !lp.slideable && mSlideableView != null) {
            ...
            if (!mOverlayContent) {
                ...
                if (mIsSlidingUp) {
                    mTmpRect.bottom = Math.min(mTmpRect.bottom, mSlideableView.getTop() + mSlideableView.getPaddingTop());
                } else {
