...
public class ViewDragHelper {
    ...
    public final static int DEFAULT_FIXED_DURATION = 800;
    private boolean mUseFixedDuration = true;
    private int mFixedDuration = DEFAULT_FIXED_DURATION;
